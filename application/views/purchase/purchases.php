    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                ...
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('list_purchase'); ?>"
            ...
            <div class="col-sm-12 col-md-6 mb-2">
                <div class="form-group">
                    <input autocomplete="off" type="text" id="startDate" name="startDate" readonly
                        ...
                        value="<?php echo isset($_POST['startDate']) && $_POST['startDate'] ? $_POST['startDate'] : '' ?>">
                </div>
            ...
            <div class="col-sm-12 col-md-6 mb-2">
                <div class="form-group">
                    <input autocomplete="off" type="text" id="endDate" name="endDate" readonly
                        ...
                        value="<?php echo isset($_POST['endDate']) && $_POST['endDate'] ? $_POST['endDate'] : '' ?>">
                </div>
                ...
                <div class="form-group">
                    <select name="supplier_id" id="supplier_id" class="form-control select2 width_100_p mx-2">
                        ...
                        <option value="<?php echo escape_output($val->id) ?>"
                            <?php echo set_select('supplier_id', $val->id); ?>><?php echo escape_output($val->name) ?>
                        </option>
                        <?php } ?>
                    </select>
                </div>
