                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <input readonly autocomplete="off" type="text" name="outlet_code" class="form-control"
                                onfocus="select();" placeholder="<?php echo lang('outlet_code'); ?>"
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" name="outlet_name" class="form-control"
                                placeholder="<?php echo lang('outlet_name'); ?>"
                                value="<?php echo escape_output($outlet_information->outlet_name); ?>">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="active_status" id="active_status">
                                <option value="active"
                                    <?php echo escape_output($outlet_information->active_status) == 'active' ? 'selected' : '' ?>>
                                    <?php echo lang('Active'); ?></option>
                                <option value="inactive"
                                    <?php echo escape_output($outlet_information->active_status) == 'inactive' ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="domain" name="domain" id="domain" class="form-control"
                                placeholder="<?php echo lang('domain'); ?>"
                                value="<?php echo escape_output($outlet_information->domain); ?>">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <textarea autocomplete="off" name="address" class="form-control"
                                placeholder="<?php echo lang('address'); ?>"><?php echo escape_output($outlet_information->address); ?></textarea>
                        </div>
