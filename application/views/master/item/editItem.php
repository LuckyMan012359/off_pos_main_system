...
<select class="hidden_variation_data display_none">
    ...
    foreach ($Variations as $key => $value):
        ...
        <option data-id="<?php echo escape_output($value->id) ?>" value="<?php echo escape_output($value->id) ?>">
            <?php echo escape_output($value->variation_name) ?>
        </option>
        <?php
    endforeach;
    ?>
        ...
        <div class="table-box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-group">
                            ...
                            <select disabled class="form-control  select2 check_type op_width_100_p" id="type"
                                name="type">
                                <option value="General_Product" <?php echo set_select('type', 'General_Product'); ?><?php echo escape_output($item_details->type) == 'General_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('general_product'); ?>
                                </option>
                                <option value="Variation_Product" <?php echo set_select('type', 'Variation_Product'); ?>
                                    <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('variation_product'); ?>
                                </option>
                                ...
                                <option value="Serial_Product" <?php echo set_select('type', 'Serial_Product'); ?> <?php echo escape_output($item_details->type) == 'Serial_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('serial_product'); ?>
                                </option>
                                <option value="Medicine_Product" <?php echo set_select('type', 'Medicine_Product'); ?>
                                    <?php echo escape_output($item_details->type) == 'Medicine_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('Medicine_Product'); ?>
                                </option>
                                <option value="Installment_Product" <?php echo set_select('type', 'Installment_Product'); ?> <?php echo escape_output($item_details->type) == 'Installment_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('installment_product'); ?>
                                </option>
                                <option value="Service_Product" <?php echo set_select('type', 'Service_Product'); ?>
                                    <?php echo escape_output($item_details->type) == 'Service_Product' ? 'selected' : '' ?>>
                                    <?php echo lang('service_product'); ?>
                                </option>
                ...
                <div class="row expiry_maintain_wrapper">
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-group">
                            ...
                            <select disabled class="form-control select2" id="expiry_date_maintain"
                                name="expiry_date_maintain">
                ...
                <div class="row">
                            ...
                            <div class="d-flex">
                                <select class="from-control select2" name="rack_id" id="rack_id">
                                    ...
                                    <?php foreach ($racks as $rack) { ?>
                                        <option <?php echo escape_output($rack->id) == $item_details->rack_id ? 'selected' : '' ?> value="<?php echo escape_output($rack->id) ?>">
                                            <?php echo escape_output($rack->name) ?>
                                        </option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>"
                        id="sale_price_group">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>"
                        id="whole_sale_price_group">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input name="profit_margin" onfocus="this.select();" type="text"
                                    ...
                                    value="<?php echo $item_details->profit_margin; ?>">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>"
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            <input readonly autocomplete="off" type="text" id="opening_stock" name="opening_stock"
                                ...
                                <div class="op_webkit_fill_available">
                                    <select class="form-control select2 op_width_100_p" id="category_id"
                                        ...
                                        <?php foreach ($categories as $ctry) { ?>
                                            <option value="<?php echo escape_output($ctry->id) ?>" <?php echo set_select('category_id', $ctry->id); ?>     <?php echo isset($item_details->category_id) && $item_details->category_id == $ctry->id ? 'selected' : '' ?>>
                                                <?php echo escape_output($ctry->name) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3" id="code_group">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" readonly type="text" onfocus="select();" id="code_" name="code"
                                class="form-control" placeholder="<?php echo lang('code'); ?>"
                                ...
                                <div class="op_webkit_fill_available">
                                    <select class="form-control disable_service select2 op_width_100_p" id="supplier_id"
                                        ...
                                        <?php foreach ($suppliers as $splrs) { ?>
                                            <option <?= isset($item_details->supplier_id) && $item_details->supplier_id && $item_details->supplier_id == $splrs->id ? 'selected' : '' ?>
                                                value="<?php echo escape_output($splrs->id) ?>" <?php echo set_select('supplier_id', $splrs->id); ?>>
                                                <?php echo escape_output($splrs->name) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field" id="select_unit_type_group">
                        <div class="form-group">
                            ...
                            <select name="unit_type" class="unit_type form-control select2 op_width_100_p"
                                id="select_unit_type">
                                <option <?= isset($item_details->unit_type) && $item_details->unit_type && $item_details->unit_type == 1 ? 'selected' : '' ?> value="1">
                                    <?php echo lang('single_unit') ?></option>
                                <option <?= isset($item_details->unit_type) && $item_details->unit_type && $item_details->unit_type == 2 ? 'selected' : '' ?> value="2">
                    ...
                    <div
                        class="col-md-6 col-lg-4 col-xl-3 mb-3 single_unit_hide_show disable_service_field <?php echo escape_output($item_details->unit_type) == 1 ? '' : 'd-none' ?>">
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                <div class="op_webkit_fill_available">
                                    <select class="form-control select2 disable_service op_width_100_p" id="unit_id"
                                        ...
                                        <?php foreach ($units as $value) { ?>
                                            <option value="<?php echo escape_output($value->id) ?>" <?php echo escape_output($item_details->sale_unit_id) == $value->id ? 'selected' : '' ?><?php echo set_select('unit_id', $value->id); ?>>
                                ...
                                <button type="button" data-unit-type="Single Unit"
                                    class="new-btn ms-1 bg-blue-btn-p-14 add_sale_unit_by_ajax">
                                    <iconify-icon icon="solar:add-circle-broken" width="22"></iconify-icon>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="cler-fix"></div>
                    <div
                        class="col-md-6 col-lg-4 col-xl-3 mb-3 double_unit_hide_show disable_service_field <?php echo escape_output($item_details->unit_type) == 2 ? '' : 'd-none' ?>">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                        ...
                        <?php if (form_error('conversion_rate')) { ?>
                            <div class="callout callout-danger my-2">
                                <span class="error_paragraph"
                                    class="error_paragraph"><?php echo form_error('conversion_rate'); ?></span>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="cler-fix"></div>
                    <div
                        class="col-md-6 col-lg-4 col-xl-3 mb-3 common_warranty disable_service_field <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                                ...
                                <div class="op_webkit_fill_available">
                                    <div class="d-flex">
                                        ...
                                        <select name="warranty_date" id="warranty_date" class="form-control select2">
                                            <option value="day" <?php echo set_select('warranty_date', 'day'); ?> <?php echo escape_output($item_details->warranty_date) == 'day' ? 'selected' : '' ?>>
                                                <?php echo lang('day'); ?>
                                            </option>
                                            <option value="month" <?php echo set_select('warranty_date', 'month'); ?>
                                                <?php echo escape_output($item_details->warranty_date) == 'month' ? 'selected' : '' ?>>
                                                <?php echo lang('month'); ?>
                                            </option>
                                            <option value="year" <?php echo set_select('warranty_date', 'year'); ?>
                                                <?php echo escape_output($item_details->warranty_date) == 'year' ? 'selected' : '' ?>>
                                                <?php echo lang('year'); ?>
                                            </option>
                                        </select>
                                    </div>
                    ...
                    <div
                        class="col-md-6 col-lg-4 col-xl-3 mb-3 common_guarantee disable_service_field <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                                ...
                                <div class="op_webkit_fill_available">
                                    <div class="d-flex">
                                        ...
                                        <select name="guarantee_date" id="guarantee_date" class="form-control select2">
                                            <option value="day" <?php echo set_select('guarantee_date', 'day'); ?> <?php echo escape_output($item_details->guarantee_date) == 'day' ? 'selected' : '' ?>>
                                                <?php echo lang('day'); ?>
                                            </option>
                                            <option value="month" <?php echo set_select('guarantee_date', 'month'); ?>
                                                <?php echo escape_output($item_details->guarantee_date) == 'month' ? 'selected' : '' ?>>
                                                <?php echo lang('month'); ?>
                                            </option>
                                            <option value="year" <?php echo set_select('guarantee_date', 'year'); ?>
                                                <?php echo escape_output($item_details->guarantee_date) == 'year' ? 'selected' : '' ?>>
                                                <?php echo lang('year'); ?>
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="op_webkit_fill_available">
                                    <select class="form-control select2 op_width_100_p" id="brand_id" name="brand_id">
                                        ...
                                        <?php foreach ($brands as $ctry) { ?>
                                            <option <?= isset($item_details->brand_id) && $item_details->brand_id && $item_details->brand_id == $ctry->id ? 'selected' : '' ?>
                                                value="<?php echo escape_output($ctry->id) ?>" <?php echo set_select('brand_id', $ctry->id); ?>>
                                                <?php echo escape_output($ctry->name) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field <?php echo escape_output($item_details->type) == 'Variation_Product' ? 'd-none' : '' ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" id="alert_quantity" name="alert_quantity"
                                class="form-control disable_service" placeholder="<?php echo lang('alert_quantity'); ?>"
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" id="description" name="description"
                                ...
                                value="<?php echo escape_output($item_details->description); ?>">
                        </div>
                ...
                <div class="row disable_service_field">
                    <div class="col-md-12 variation_div_0" id="variation_wrap">
                                    ...
                                    if (isset($variation_details) && $variation_details) {
                                            ...
                                            <tr class="bottom_border">
                                                <td class="padding_0">
                                                    <select
                                                        ...
                                                        foreach ($Variations as $key => $value):
                                                            ?>
                                                            <option <?= isset($variation_details_plan->attribute_id) && $variation_details_plan->attribute_id == $value->id ? 'selected' : '' ?>
                                                ...
                                                <td>
                                                    <select data-selected_value="<?php echo $selected_value ?>"
                                                        class="form-control select_multiple child_row_attribute check_required child_row_counter<?= ($key_va) ?>">
                                                        <option value=""><?php echo lang('select'); ?></option>
                                                    </select>
                                                    <a href="javascript:void(0)"
                                                        class="new-btn bg-blue-btn-p-14 mt-2 add_row margin_top_2 pull-right">
                                                        <iconify-icon icon="solar:add-circle-broken" width="22"></iconify-icon>
                                                    </a>
                                                </td>
                                                <td class="c_center">
                                                    <a class="remove_row new-btn-danger" href="javascript:void(0)">
                                                        <iconify-icon icon="solar:trash-bin-minimalistic-broken"
                                                            class="color-red" width="22"></iconify-icon>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
                                        ...
                                        <tr class="bottom_border">
                                            <td class="padding_0">
                                                ...
                                                <br>
                                                <label><input type="checkbox" name="visible_on_product"
                                                        class="visible_on_product" value="1">
                                                    <?php echo lang('Visible_on_the_product_page'); ?></label><br>
                                                <label><input type="checkbox" name="used_for_variations"
                                                        class="used_on_variation" value="1">
                                                    <?php echo lang('Used_for_variations'); ?></label>
                                            </td>
                                            <td>
                                                <select
                                                    class="form-control child_row_attribute check_required child_row_counter0">
                                                    <option value=""><?php echo lang('select'); ?></option>
                                                </select>
                                                <a href="javascript:void(0)"
                                                    class="btn bg-blue-btn bg-blue-btn-p-14 btn-sm mt-2 add_row margin_top_2 pull-right"><i
                                                        class="fa fa-plus"></i> <?php echo lang('add_new'); ?></a>
                                            </td>
                                            <td class="c_center">
                                                <a class="remove_row" href="javascript:void(0)"><i
                                                        class="color_red fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                        ...
                        <div
                            class="variation_div_2 <?php echo escape_output($item_details->type) == 'Variation_Product' ? '' : 'op-d-none' ?>">
                            <button type="button" class="new-btn bg-blue-btn-p-14 back_to_attribute">
                                ...
                                <tbody id="variation_container_div">
                                    ...
                                    if (isset($variation_products) && $variation_products):
                                        foreach ($variation_products as $k_v_p => $vp_value):
                                            ...
                                            <tr class="heading_tr">
                                                <th colspan="4">
                                                    <input type="hidden" value="<?php echo escape_output($vp_value->id) ?>"
                                                        name="old_variation_id[]">
                                                    <input type="hidden" value="<?php echo escape_output($vp_value->name) ?>"
                                                        name="variation_name[]"> #<span class="counter_variation"></span>
                                                    <?php echo escape_output($vp_value->name) ?>
                                                    <div class="pull-right"><span class="cursor_tr show_details_view">
                                                            <iconify-icon data-status="1" class="arrow_status"
                                                                icon="solar:arrow-up-broken" width="22"></iconify-icon>
                                                        </span><span class="cursor_pointer">
                                                            <iconify-icon class="row_remove_variation color-red"
                                                                icon="solar:trash-bin-minimalistic-broken" width="22">
                                                            </iconify-icon>
                                                        </span></div>
                                                </th>
                                            </tr>
                                            <tr class="display_none show_details_view_sub_div1">
                                                <td class="op_width_20_p txt-uh-41 c_center" rowspan="2">
                                                    <input type="hidden" class="variation_product_images"
                                                        value="<?php echo escape_output($vp_value->photo) ?>">
                                                    <?php if ($vp_value->photo) { ?>
                                                        <img class="width_45_p add_image_for_crop_variation cursor_tr"
                                                            src="<?= base_url() ?>uploads/items/<?= escape_output($vp_value->photo) ?>">
                                                    <?php } else { ?>
                                                        <img class="width_45_p add_image_for_crop_variation cursor_tr"
                                                            src="<?= base_url() ?>uploads/site_settings/image_thumb.png">
                                                    <?php } ?>
                                                    <iconify-icon class="image_div cursor_pointer color-red"
                                                        icon="solar:trash-bin-minimalistic-broken" width="22"></iconify-icon>
                                                </td>
                                                <td class="op_width_20_p form-group">
                                                    <label><?php echo lang('sale_price'); ?> <span
                                                            class="required_star">*</span></label>
                                                    <input type="text"
                                                        class="form-control integerchk default_sale_price_variation check_required_variation"
                                                        onfocus="select()" placeholder="<?php echo lang('sale_price'); ?>"
                                                        value="<?php echo escape_output($vp_value->sale_price) ?>">
                                                </td>

                                                <td class="op_width_20_p form-group">
                                                    <label><?php echo lang('whole_sale_price'); ?> <span
                                                            class="required_star">*</span></label>
                                                    <input type="number" onfocus="select()"
                                                        class="form-control default_whole_sale_price_variation check_required_variation"
                                                        placeholder="<?php echo lang('whole_sale_price'); ?>"
                                                        value="<?php echo escape_output($vp_value->whole_sale_price) ?>">
                                                </td>
                                                ...
                                                <td class="width_100_p form-group" colspan="2">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <label><?php echo lang('purchase_price'); ?> <span
                                                                class="required_star">*</span></label>
                                                        <span><i data-tippy-content="<?php echo lang('guide_purchase_price'); ?>"
                                                                class="fa-regular fa-circle-question tippyBtnCall font-16 theme-color"></i></span>
                                                    </div>
                                                    <input type="text"
                                                        class="form-control integerchk default_purchase_price_variation check_required_variation"
                                            ...
                                            <tr class="display_none show_details_view_sub_div3">
                                                <td class="op_width_20_p form-group">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span><i data-tippy-content="<?php echo lang('in_sale_unit'); ?>"
                                                                class="fa-regular fa-circle-question tippyBtnCall font-16 theme-color"></i></span>
                                                    </div>
                                                    <input type="number" onfocus="select()" serial_e="<?php echo $k_v_p; ?>"
                                                        data-item="<?php echo escape_output($vp_value->id) ?>"
                                                        class="form-control opening_stock_variation stock_view"
                                                        placeholder="<?php echo lang('opening_stock'); ?>"
                                                        value="<?php echo getItemOpeningStockAndConversionRate($vp_value->id); ?>">
                                                    <div class="op_stock_set d-none">
                                                        <?php foreach ($outlets as $outlet) { ?>
                                                            <input type="hidden" name="outlets<?php echo $k_v_p ?>[]"
                                                                value="<?php echo escape_output($outlet->id); ?>">
                                                            <input type="hidden" name="quantity<?php echo $k_v_p ?>[]"
                                                                value="<?php echo getVariationOpeningStock($vp_value->id, $outlet->id); ?>">
                                                        <?php } ?>
                                                    </div>
                                                </td>
                                                <td class="op_width_20_p form-group">
                                                    <label><?php echo lang('code'); ?> <span
                                                            class="required_star">*</span></label>
                                                    <input type="text" onfocus="select()"
                                                        class="form-control code_variation check_required_variation"
                                                        placeholder="<?php echo lang('code'); ?>"
                                                        value="<?php echo escape_output($vp_value->code) ?>">
                                                </td>
                                                <td class="op_width_20_p form-group" colspan="2">
                                                    ...
                                                    <input type="number" onfocus="select()"
                                                        class="form-control alert_quantity_variation"
                                                        placeholder="<?php echo lang('alert_quantity'); ?>"
                                                        value="<?php echo escape_output($vp_value->alert_quantity) ?>">
                                                </td>
                                            </tr>
                                            <?php
                                        endforeach;
                                            ...
                                            <tr data-item_id="">
                                                ...
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input check_box_trigger" type="checkbox"
                                                            id="inlineCheckbox1" <?php echo escape_output($combo->show_invoice == 'Yes' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label" for="inlineCheckbox1"></label>
                                                        <input type="hidden" name="item_show_in_invoice[]" class="checkbox_el"
                                                            value="<?php echo escape_output($combo->show_invoice == 'Yes' ? 'on' : 'off'); ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input autocomplete="off" type="text" onfocus="select();"
                                                            name="combo_item_qty[]"
                                                            class="form-control integerchk comboCalculation quantity"
                                                            placeholder="Quantity"
                                                            value="<?php echo escape_output($combo->quantity); ?>">
                                                        <input type="hidden" name="combo_item_id[]"
                                                            value="<?php echo escape_output($combo->item_id); ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input autocomplete="off" type="text" onfocus="select();"
                                                            name="combo_item_unitprice[]"
                                                            class="form-control integerchk comboCalculation unit_price"
                                                            placeholder="Unit Price"
                                                            value="<?php echo escape_output($combo->unit_price); ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input autocomplete="off" type="text" onfocus="select();" name=""
                                                            class="form-control integerchk combo_total" placeholder="Total"
                                                            readonly
                                                            value="<?php echo escape_output((int) $combo->quantity * (int) $combo->unit_price); ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <span
                                                        class="combo_trash_trigger cursor-pointer new-btn-danger justify-content-center d-inline-flex">
                                                        <iconify-icon icon="solar:trash-bin-minimalistic-broken" width="18">
                                                        </iconify-icon>
                                                    </span>
                                                </td>
                                            </tr>
                                    ...
                                    <td class="w-15">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="text" name="combo_sale_subtotal"
                                                ...
                                                value="<?php echo getAmt($grand_total_sum); ?>">
                                        </div>
                                    </td>
                                    <td class="w-5"></td>
                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" name="tax_field_percentage[]"
                                                            class="form-control integerchk for_items <?php echo escape_output($item_details->type) == 'Installment_Product' ? 'off-d-none' : '' ?>"
                                                            placeholder=""
                                            ...
                                            <table class="ir_w_100 mt_0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" name="tax_field_percentage[]"
                                                            class="form-control integerchk for_items <?php echo escape_output($item_details->type) == 'Installment_Product' ? 'off-d-none' : '' ?>"
                                                            placeholder="" value="<?php echo escape_output($tax_percentage) ?>">
                ...
                <div class="item_append">
                    ...
                    if (isset($_POST['outlets'])) {
                        ...
                        foreach ($stockDetails as $stok_d) { ?>
                            ...
                            <input type="hidden" name="quantity[]"
                                value="<?php echo (float) $stok_d->stock_quantity / (float) $item_details->conversion_rate; ?>">
                            <input type="hidden" name="item_description[]"
                                value="<?php echo escape_output($stok_d->item_description); ?>">
                        <?php }
                    } ?>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                </h4> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true"><i data-feather="x"></i></span></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="addPurchaseUnitModal" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo lang('add_purchase_unit'); ?>
                </h4> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true"><i data-feather="x">×</i></span></button>
...
<div class="modal fade" id="AddItemImageModal" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button"
                    class="btn bg-blue-btn bg-blue-btn-p-14 upload-result"><?php echo lang('crop'); ?></button>
                <button type="button" class="btn bg-blue-btn bg-blue-btn-p-14"
                    data-bs-dismiss="modal"><?php echo lang('close'); ?></button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="add_variation_attribute_modal" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn bg-blue-btn bg-blue-btn-p-14 add_new_attribute">
                    <?php echo lang('submit'); ?></button>
                <button type="button" class="btn bg-blue-btn bg-blue-btn-p-14"
                    data-bs-dismiss="modal"><?php echo lang('close'); ?></button>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="upload-demo-i" class="text-center">
                    ...
                    <?php } else { ?>
                        <img class="img-responsive op_margin_bottom_5"
                            src="<?= base_url() . 'uploads/site_settings/image_thumb.png' ?>" alt="Photo" height="100"
                            width="100">
                    <?php } ?>
                </div>
            </div>
...
<div class="modal fade" id="opening_stock_modal" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    <?php echo lang('opening_stock_set_for_outlet'); ?>
                </h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true"><i data-feather="x"></i></span></button>
            </div>
                    ...
                    <?php if ($item_details->type == 'General_Product' || $item_details->type == 'Installment_Product') { ?>
                        <?php foreach ($outlets as $outlet) { ?>
                            <div class="card p-3 mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <label for="outlet_<?php echo escape_output($outlet->id); ?>"
                                        class="form-label"><?php echo lang('quantity'); ?></label>
                                    <input type="text"
                                        class="form-control integerchk quantity_trigger general_product_stock_check"
                                        data-outlet="<?php echo escape_output($outlet->id); ?>"
                                        data-item="<?php echo escape_output($item_details->id); ?>"
                                ...
                                <div class="card p-3 mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="outlet_<?php echo escape_output($outlet->id); ?>"
                                            class="form-label"><?php echo lang('quantity'); ?></label>
                                        <input readonly type="text"
                                            class="form-control integerchk quantity_trigger imeiserial_product_stock_check mb-2"
                                            data-outlet="<?php echo escape_output($outlet->id); ?>"
                                            data-item="<?php echo escape_output($item_details->id); ?>"
                                            placeholder="<?php echo lang('quantity'); ?>"
                                            id="outlet_<?php echo escape_output($outlet->id); ?>" value="">
                                        <div
                                            class="form_clear_trigger item_description_body_<?php echo escape_output($outlet->id); ?>">
                                        </div>
                    ...
                    <?php } else if ($item_details->type == 'Medicine_Product') { ?>
                        <?php foreach ($outlets as $outlet) { ?>
                                    <div class="card p-3 mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="outlet_<?php echo escape_output($outlet->id); ?>"
                                                class="form-label"><?php echo lang('total'); ?>         <?php echo lang('quantity'); ?></label>
                                            <input readonly type="text"
                                                class="form-control integerchk quantity_trigger Medicine_Product_stock_check mb-2"
                                                data-outlet="<?php echo escape_output($outlet->id); ?>"
                                                data-item="<?php echo escape_output($item_details->id); ?>"
                                                placeholder="<?php echo lang('quantity'); ?>"
                                                id="outlet_<?php echo escape_output($outlet->id); ?>" value="">
                                        ...
                                        <div class="card p-3 mb-3">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="outlet_<?php echo escape_output($outlet->id); ?>"
                                                    class="form-label"><?php echo lang('quantity'); ?></label>
                                                <input type="text"
                                                    class="form-control integerchk quantity_trigger variation_product_stock_check"
                                                    data-outlet="<?php echo escape_output($outlet->id); ?>" data-item=""
                                                    placeholder="<?php echo lang('quantity'); ?>"
                                                    id="outlet_<?php echo escape_output($outlet->id); ?>">
                                            </div>
                                        </div>
