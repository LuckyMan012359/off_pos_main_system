...
<head>
    ...
    <!-- Font Awesome 6.5.1-->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/plugins/fontawesome-free-6.5.1-web/css/all.min.css?var=1.6">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/style.css?var=1.6" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/local/google_font_POS.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/font_awesome_all.css?var=1.6" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/sweetalert2-new.min.css?var=1.6"
        type="text/css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>frequent_changing/newDesign/lib/perfect-scrollbar/dist/perfect-scrollbar.css?var=1.6">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/bower_components/select2/dist/css/select2.min.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/jquery-ui.css?var=1.6" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/virtual_keyboard/keyboard.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/custom_theme.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/main_screen.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/pos-screen-loader.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/register_details.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/customModal.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/jquery.dataTables.min.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/buttons.dataTables.min.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/custom_check_box.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/main_screen_finalize.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/main_screen_responsive.css?var=1.6"
        type="text/css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>frequent_changing/newDesign/pos/js/perfect-scrollbar.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/notify/toastr.css?var=1.6" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/newDesign/pos/sass/animate.min.css?var=1.6"
        type="text/css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>frequent_changing/newDesign/pos/lib/date/datepicker.css?var=1.6" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/newDesign/pos/sass/scale.css?var=1.6"
        type="text/css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/newDesign/pos/sass/tippy.css?var=1.6"
        type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/pos_responsive.css?var=1.6"
        type="text/css">
    <style>
...
<body>
    ...
    <input type="hidden" id="register_status"
        value="<?php echo escape_output($this->session->userdata('register_status')); ?>">
    ...
    <input type="hidden" id="op_decimals_separator"
        value="<?php echo escape_output($this->session->userdata('decimals_separator')) ?>">
    <input type="hidden" id="op_thousands_separator"
        value="<?php echo escape_output($this->session->userdata('thousands_separator')) ?>">
    ...
    <input type="hidden" id="invoice_print"
        value="<?php echo escape_output($this->session->userdata('invoice_print')); ?>">
    <input type="hidden" id="op_date_format"
        value="<?php echo escape_output($this->session->userdata('date_format')); ?>">
    <input type="hidden" id="gst_state_code"
        value="<?php echo escape_output($this->session->userdata('gst_state_code')); ?>">
    <input type="hidden" id="direct_cart" value="<?php echo escape_output($this->session->userdata('direct_cart')); ?>">
    <input type="hidden" id="default_customer"
        value="<?php echo escape_output($this->session->userdata('default_customer')); ?>">
    <input type="hidden" id="sms_enable_status" value="<?php echo escape_output($getCompanyInfo->sms_enable_status); ?>">
    <input type="hidden" id="smtp_enable_status"
        value="<?php echo escape_output($getCompanyInfo->smtp_enable_status); ?>">
    <input type="hidden" id="send_invoice_whatsapp"
        value="<?php echo escape_output($getCompanyInfo->whatsapp_invoice_enable_status); ?>">
    <input type="hidden" id="default_payment_hidden"
        value="<?php echo escape_output($this->session->userdata('default_payment')); ?>">
    <input type="hidden" id="pos_total_payable_type"
        value="<?php echo escape_output($this->session->userdata('pos_total_payable_type')); ?>">
    <input type="hidden" id="onscreen_keyboard_status"
        value="<?php echo escape_output($this->session->userdata('onscreen_keyboard_status')); ?>">
    <input type="hidden" id="view_purchase_price"
        value="<?php echo escape_output($this->session->userdata('view_purchase_price')); ?>">
    <input type="hidden" id="tax_type" value="<?php echo escape_output($this->session->userdata('tax_type')); ?>">
    <input type="hidden" id="stripe_publish_key" value="<?php echo $payment_info->stripe_publishable_key; ?>"><input
        type="hidden" id="scrollwindow" value="<?php echo base_url() ?>">
    <input type="hidden" id="grocery_experience"
        value="<?php echo escape_output($this->session->userdata('grocery_experience')); ?>">
    <input type="hidden" id="generic_name_search_option"
        value="<?php echo escape_output($this->session->userdata('generic_name_search_option')); ?>">
    <input type="hidden" id="business_name"
        value="<?php echo escape_output($this->session->userdata('business_name')); ?>">
    ...
    <input type="hidden" id="outlet_email"
        value="<?php echo escape_output($this->session->userdata('outlet_email')); ?>">
    ...
    <input type="hidden" id="tax_registration_no"
        value="<?php echo escape_output($this->session->userdata('tax_registration_no')); ?>">
    ...
    <input type="hidden" id="pharmacy_search_place_holder_pos"
        value="<?php echo lang('pharmacy_search_place_holder_pos'); ?>">
    ...
    <input type="hidden" id="no_permission_for_this_module"
        value="<?php echo lang('no_permission_for_this_module'); ?>">
    <input type="hidden" id="product_display"
        value="<?php echo escape_output($this->session->userdata('product_display')); ?>">
    <input type="hidden" id="The_discount_code_field_required"
        value="<?php echo lang('The_discount_code_field_required'); ?>">
    <input type="hidden" id="The_coupon_code_field_required"
        value="<?php echo lang('The_coupon_code_field_required'); ?>">
    ...
    <input type="hidden" id="loyalty_point_is_not_available"
        value="<?php echo lang('loyalty_point_is_not_available'); ?>">
    <input type="hidden" id="Alternative_Medicine_will_shown_here"
        value="<?php echo lang('Alternative_Medicine_will_shown_here'); ?>">
    <input type="hidden" id="default_cursor_position"
        value="<?php echo escape_output($this->session->userdata('default_cursor_position')); ?>">
    <input type="hidden" id="your_added_payment_method_will_remove"
        value="<?php echo lang('your_added_payment_method_will_remove'); ?>">
    <input type="hidden" id="loyalty_point_not_applicable"
        value="<?php echo lang('loyalty_point_not_applicable_for_walk_in_customer'); ?>">
    ...
    <div class="wrapper fix">
                    ...
                    <ul class="icon__menu">
                        <li class="has__children main_menu">
                            <a tabindex="-1" href="javascript:void(0)" class="header_menu_icon dropdown-menu"
                                data-tippy-content="<?php echo lang('Main_Menu'); ?>">
                                <iconify-icon icon="solar:user-check-broken" width="22"></iconify-icon>
                            </a>
                            <ul class="sub__menu custom_dropdown" role="menu">
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url(); ?>User/changeProfile"
                                        class="offline_prevent"><?php echo lang('change_profile'); ?></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url(); ?>User/changePassword"
                                        class="offline_prevent"><?php echo lang('change_password'); ?></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url(); ?>User/securityQuestion"
                                        class="offline_prevent"><?php echo lang('SetSecurityQuestion'); ?></a>
                                </li>
                                <li>
                                    <a tabindex="-1" class="logOutTrigger offline_prevent"
                                        href="javascript:void(0)"><?php echo lang('logout'); ?></a>
                                </li>
                            </ul>
                        </li>
                        <!-- Langulage -->
                        <li class="has__children languages">
                            ...
                            ?>
                            <a tabindex="-1" href="javascript:void(0)" class="header_menu_icon dropdown-menu"
                                data-tippy-content="<?php echo lang('Language'); ?>">
                            ...
                            <ul class="sub__menu" role="menu">
                                ...
                                foreach ($dir as $value):
                                    ...
                                    <li data-lang="English">
                                        <a tabindex="-1" class="offline_prevent"
                                            href="<?php echo base_url() ?>Authentication/setlanguage/<?php echo escape_output($separete[1]) ?>">
                                            <span><?php echo ucfirstcustom($separete[1]) ?></span>
                                        </a>
                                    </li>
                                    <?php
                                endforeach;
                        ...
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" id="open_hold_sales" class="header_menu_icon"
                                data-tippy-content="<?php echo lang('Open_Draft_Sales'); ?>">
                        ...
                        <li><a tabindex="-1" href="javascript:void(0)" class="header_menu_icon" id="print_last_invoice"
                                data-tippy-content="<?php echo lang('print_last_invoice'); ?>">
                                <iconify-icon icon="solar:printer-broken" width="22"></iconify-icon>
                            </a></li>
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" id="last_ten_sales_button"
                                class="header_menu_icon" data-tippy-content="<?php echo lang('Recent_Sales'); ?>">
                                <iconify-icon icon="solar:history-broken" width="22"></iconify-icon>
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" id="calculator_button"
                                class="header_menu_icon calculator_button"
                                data-tippy-content="<?php echo lang('calculator'); ?>">
                                <iconify-icon icon="solar:calculator-minimalistic-broken" width="22"></iconify-icon>
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" id="register_details"
                                class="header_menu_icon register_details"
                        ...
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" id="keyboard_short_cut" class="header_menu_icon "
                                data-tippy-content="<?php echo lang('keyboard_short_cut'); ?>">
                                <iconify-icon icon="solar:keyboard-broken" width="22"></iconify-icon>
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="<?php echo base_url(); ?>Dashboard/dashboard" target="_blank"
                                class="header_menu_icon offline_prevent"
                                data-tippy-content="<?php echo lang('dashboard'); ?>">
                                <iconify-icon icon="solar:chart-2-broken" width="22"></iconify-icon>
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="<?php echo base_url() ?>customer-panel"
                                class="header_menu_icon offline_prevent" target="_blank"
                                data-tippy-content="<?php echo lang('customer_panel'); ?>">
                    ...
                    <ul class="icon__menu">
                        ...
                        <li>
                            <a tabindex="-1" href="javascript:void(0)" class="header_menu_icon fullscreen"
                                data-tippy-content="<?php echo lang('Full_Screen'); ?>">
                                <iconify-icon icon="solar:maximize-square-3-broken" width="22"></iconify-icon>
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="javascript:void(0)"
                                data-tippy-content="<?php echo lang('Main_Menu'); ?>" id="open__menu"
                                class="header_menu_icon offline_prevent">
            ...
            <div class="header_part_right">
                ...
                <ul class="btn__menu">
                    ...
                    <li>
                        <div class="switchary_wrap" <?php echo APPLICATION_MODE == 'demo' ? 'data-tippy-content="This button is disabled for demo. to check medicine shop experience please check medicine demo!"' : '' ?>>
                            <select id="grocery_experience_el" class="select2" <?php echo APPLICATION_MODE == 'demo' ? 'disabled' : '' ?>>
                                ...
                                <option value="Regular" <?php echo $grocery_experience == 'Regular' ? 'selected' : '' ?>>
                                    <?php echo lang('Regular'); ?>
                                </option>
                                <option value="Medicine" <?php echo $grocery_experience == 'Medicine' ? 'selected' : '' ?>>
                                    <?php echo lang('Medicine'); ?>
                                </option>
                                <option value="Grocery" <?php echo $grocery_experience == 'Grocery' ? 'selected' : '' ?>>
                                    <?php echo lang('Grocery'); ?>
                                </option>
                            </select>
                        </div>
                    </li>
                    <li class="has__children">
                        <a tabindex="-1" href="javascript:void(0)"
                            class="bg__green online_sync d-flex align-items-center me-2">
                    ...
                    <li>
                        <a tabindex="-1" href="javascript:void(0)" data-id=""
                            class="bg__blue button_category_show_all"><?php echo lang('all'); ?></a>
                    </li>
                    <li class="has__children">
                        <a tabindex="-1" href="javascript:void(0)"
                            class="show__brand__list bg__blue off-pos-open-dropdown-menu"><?php echo lang('brand'); ?></a>
                        <div class="submenu-wrapper">
                            <ul class="sub__menu brand__sub__menu">
                                <li>
                                    <a tabindex="-1" href="javascript:void(0)" data-id=""
                                        class="category_button button_category_show_all brand_all_category"><?php echo lang('all'); ?></a>
                                </li>
                                <?php
                                $i = 1;
                                foreach ($brands as $brand):
                                    if ($brand->name != "N/A"):
                                        if ($i = 1):
                                            ?>
                                            <li>
                                                <a tabindex="-1" href="javascript:void(0)" class="brand_button"
                                                    id="brand_category_<?= $brand->id ?>">
                                                    <?= $brand->name ?>
                                                </a>
                                            </li>
                                        <?php else: ?>
                    ...
                    <li class="has__children sorting_item_wrapper">
                        <a href="javascript:void(0)"
                            class="bg__blue off-pos-open-dropdown-menu sorting_item_title"><?php echo lang('Most_Selling'); ?></a>
                        <div class="submenu-wrapper">
                            <ul class="sub__menu">
                                <li><a tabindex="-1" data-sort_id="1" class="sorting_item"
                                        href="javascript:void(0)"><?php echo lang('Most_Selling'); ?></a></li>
                                <li><a tabindex="-1" data-sort_id="2" class="sorting_item"
                                        href="javascript:void(0)"><?php echo lang('less_selling'); ?></a></li>
                                <li><a tabindex="-1" data-sort_id="3" class="sorting_item"
                                        href="javascript:void(0)"><?php echo lang('not_selling'); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="has__children">
                        <a tabindex="-1" href="javascript:void(0)"
                            class="bg__blue promo_filter offline_prevent"><?php echo lang('Promo'); ?></a>
                    </li>
                </ul>
            </div>
        ...
        <!-- Start Main Mart -->
        <div id="main_part"
            class="<?php echo $grocery_experience == 'Medicine' ? 'grocery_main_part_on' : ($grocery_experience == 'Grocery' ? 'grocery_main_part_on main_part_pharmacy' : ($grocery_experience == 'Regular' ? 'grocery_main_part_off main_part_pharmacy' : '')); ?>">
                        ...
                        <div class="single_button_middle_holder">
                            <div class="search-holder">
                                <div class="user_panner">
                                    <select name="select_employee_id" id="select_employee_id" class="select2"
                                        tabindex="1">
                                        ...
                                        foreach ($waiters as $value):
                                            if ($value->id != 1 && $value->id != 0):
                                                ?>
                                                <option <?php echo escape_output($value->id) == $logedin_user ? 'selected' : '' ?>
                                ...
                                <div class="customer_pannel">
                                    ...
                                    <input type="hidden" name="old_sale_id" id="old_sale_id"
                                        value="<?php echo isset($sale_id) && $sale_id ? $sale_id : ''; ?>">
                                </div>
                            </div>
                ...
                <div class="main_center">
                    <div class="order_table_holder">
                        <div class="order_table_header_row">
                            ...
                            <div class="single_header_column" id="single_order_discount"><?php echo lang('discount'); ?>
                            </div>
                            <div class="single_header_column" id="single_order_total"><?php echo lang('sub_total'); ?>
                            </div>
                        </div>
                        ...
                        <div class="order_holder">
                            ...
                            if (!empty($sale_item_details)) {
                                ...
                                foreach ($sale_item_details as $sale_details) {
                                    ?>
                                    <div data-variation-parent="<?php echo escape_output($sale_details->parent_id); ?>"
                                        class="single_order"
                                        is_promo="<?php echo escape_output($sale_details->is_promo_item); ?>"
                                        data-qty_default="<?php echo escape_output($sale_details->qty); ?>"
                                        data-sale-unit="<?php echo escape_output($sale_details->unit_name); ?>"
                                        id="order_for_item_<?php echo escape_output($sale_details->food_menu_id); ?>"
                                        data_cart_item_id="<?php echo escape_output($sale_details->food_menu_id); ?>">
                                        <div class="first_portion">
                                            <span
                                                id="item_seller_table<?php echo escape_output($sale_details->food_menu_id); ?>"
                                                class="d-none">
                                                <?php echo escape_output($sale_details->item_IMEI_Serial ?? ''); ?>
                                            </span>
                                            <span class="item_type d-none"
                                                id="item_type_table<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                <?php echo escape_output($sale_details->type); ?>
                                            </span>
                                            <span class="item_vat d-none"
                                                id="item_vat_percentage_table<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                <?php echo escape_output($sale_details->menu_taxes); ?>
                                            </span>
                                            <span class="item_discount d-none"
                                                id="item_discount_table<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                <?php echo escape_output($sale_details->discount_amount); ?>
                                            </span>
                                            <span class="item_price_without_discount d-none"
                                                id="item_price_without_discount_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                <?php echo escape_output($sale_details->menu_price_without_discount); ?>
                                            </span>
                                            <div class="single_order_column first_column">
                                                <iconify-icon icon="solar:pen-broken" class="op_cursor_pointer edit_item"
                                                    id="edit_item_<?php echo escape_output($sale_details->food_menu_id); ?>"
                                                    width="22"></iconify-icon>
                                                <span
                                                    id="item_name_table_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                    <?php echo escape_output($sale_details->item_name) . '(' . $sale_details->item_code . ')'; ?>
                                                </span>
                                            </div>
                                            <div class="single_order_column second_column">
                                                <span
                                                    id="item_price_table_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                    <?php echo getAmtPre($sale_details->menu_unit_price); ?>
                                                </span>
                                            </div>

                                            <div class="single_order_column third_column">
                                                <iconify-icon icon="uil:minus" class="decrease_item_table op_cursor_pointer"
                                                    id="decrease_item_table_<?php echo escape_output($sale_details->food_menu_id); ?>"
                                                    width="22"></iconify-icon>
                                                <span class="cart_quantity"
                                                    id="item_quantity_table_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                    <?php echo escape_output($sale_details->qty); ?>
                                                </span>
                                                <iconify-icon icon="uil:plus" class="increase_item_table op_cursor_pointer"
                                                    id="increase_item_table_<?php echo escape_output($sale_details->food_menu_id); ?>"
                                                    width="22"></iconify-icon>
                                            </div>
                                            <div class="single_order_column forth_column">
                                                <input type="" onfocus="select();" inline_dis_column="" placeholder="Amt or %"
                                                    class="special_textbox access_control inline_dis_column"
                                                    id="percentage_table_<?php echo escape_output($sale_details->food_menu_id); ?>"
                                                    data-discount_for_edit="<?php echo escape_output($sale_details->menu_discount_value); ?>"
                                                    value="<?php echo escape_output($sale_details->menu_discount_value); ?>">
                                            </div>
                                            <div class="single_order_column fifth_column">
                                                <span
                                                    id="item_total_price_table_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                                    <?php echo getAmtPre($sale_details->menu_price_with_discount); ?>
                                                </span>
                                                <iconify-icon icon="solar:trash-bin-minimalistic-broken"
                                                    data-remove-order-row-no="<?php echo $loop_iteration; ?>"
                                                    class="remove_this_item_from_cart" width="22"></iconify-icon>
                                            </div>
                                        </div>
                                        ...
                                        if ($sale_details->type == 'IMEI_Product' || $sale_details->type == 'Serial_Product' || $sale_details->type == 'Medicine_Product') { ?>
                                            <span class="imei_serial_note"
                                                id="expiry_imei_serial"><?php echo checkItemShortType($sale_details->type) ?>:
                                                <span
                                                    class="expiry_imei_serial_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                        ...
                                        <!-- Item Note -->
                                        <span
                                            class="cart_item_modal_des item_modal_description_table_<?php echo escape_output($sale_details->food_menu_id); ?>">
                                            <?php if ($sale_details->menu_note != '') {
                                                echo trim($sale_details->menu_note);
                                            } ?>
                                        </span>
                                        ...
                                        if ($sale_details->is_promo_item == 'Yes') {
                                            ...
                                            if ($getFreeItem) {
                                                foreach ($getFreeItem as $f_item) {
                                                    ?>
                                                    <div class="free-item free_item_div_<?php echo escape_output($sale_details->food_menu_id) ?>"
                                                        data-free-item-id="<?php echo escape_output($f_item->food_menu_id) ?>"
                                                        data-get_fm_id="<?php echo escape_output($f_item->promo_parent_id) ?>"
                                                        data-is_free="Yes">
                                                        <div data-id="<?php echo escape_output($f_item->food_menu_id) ?>"
                                                            class="customer_panel single_order_column first_column">
                                                            <iconify-icon icon="solar:pen-broken" class="op_cursor_pointer free_edit_item"
                                                                width="22" data-parent_id=""></iconify-icon>
                                                            <span class="4_cp_name_<?php echo escape_output($sale_details->food_menu_id) ?>"
                                                                id="free_item_name_table_<?php echo escape_output($sale_details->food_menu_id) ?>"><?php echo escape_output($sale_details->item_name) . '(' . $sale_details->item_code . ')'; ?></span>
                                                        </div>
                                                        <div class="single_order_column second_column text-center">
                                                            <span
                                                                id="free_item_price_table_<?php echo escape_output($sale_details->food_menu_id) ?>"><?php echo getAmtPre(0); ?></span>
                                                        </div>
                                                        <div class="single_order_column third_column">
                                                            <i class="fas fa-minus alert_free_item_increase decrease_item_table"></i>
                                                            <span
                                                                class="4_cp_qty_<?php echo escape_output($sale_details->food_menu_id) ?> qty_item_custom cart_quantity"
                                                                id="free_item_quantity_table_<?php echo escape_output($sale_details->food_menu_id) ?>"><?php echo escape_output($f_item->qty); ?></span>
                                                            <i class="fas fa-plus alert_free_item_increase increase_item_table"></i>
                                                        </div>
                                                        <div class="single_order_column forth_column">
                                                            <input type="" onfocus="select();" placeholder="Amt or %"
                                                                class="discount_cart_input" value="0" disabled>
                                                        </div>
                                                        <div class="single_order_column fifth_column text-right">
                                                            <span
                                                                id="free_item_total_price_table_<?php echo escape_output($sale_details->food_menu_id) ?>"><?php echo getAmtPre(0); ?></span>
                                                            <i data-id="<?php echo escape_output($sale_details->food_menu_id) ?>"
                                                                class="free-item-remove fas fa-times-circle removeCartItemFree"></i>
                                                        </div>
                                                    </div>
                                                <?php }
                                            }
                                        ...
                                        if ($sale_details->item_type == 'Combo_Product') {
                                            ...
                                            if ($combo_items) {
                                                foreach ($combo_items as $combo) {
                                                    ?>
                                                    <div class="combo_cart_item combo_item_div_<?php echo $combo->combo_item_id ?>"
                                                        data-is_combo="Yes">
                                                        <div data-id="<?php echo $combo->combo_item_id ?>"
                                                            class="customer_panel single_order_column first_column">
                                                            <iconify-icon icon="solar:pen-broken" class="op_cursor_pointer" width="22"
                                                                data-parent_id=""></iconify-icon>
                                                            <span
                                                                id="combo_item_name_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->item_name ?></span>
                                                            <span
                                                                id="combo_item_type_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->combo_item_type ?></span>
                                                            <span class="d-none"
                                                                id="combo_seller_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->combo_item_seller_id ?></span>
                                                            <span class="d-none"
                                                                id="combo_inv_show_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->show_in_invoice ?></span>
                                                            <span class="d-none"
                                                                id="combo_ifsale_table_<?php echo $combo->combo_item_id ?>">Yes</span>
                                                        </div>
                                                        <div class="single_order_column second_column text-center">
                                                            <span
                                                                id="combo_item_price_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->combo_item_price ?></span>
                                                        </div>
                                                        <div class="single_order_column third_column">
                                                            <iconify-icon icon="uil:minus"
                                                                class="alert_combo_item_increase op_cursor_pointer decrease_item_table"
                                                                id="combo_decrease_item_table_<?php echo $combo->combo_item_id ?>"
                                                                width="22"></iconify-icon>
                                                            <span
                                                                class="4_cp_qty_<?php echo $combo->combo_item_id ?> qty_item_custom cart_quantity"
                                                                id="combo_item_quantity_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->combo_item_qty ?></span>
                                                            <iconify-icon icon="bitcoin-icons:plus-outline"
                                                                class="alert_combo_item_increase op_cursor_pointer"
                                                                id="increase_item_table_<?php echo $combo->combo_item_id ?>" width="22">
                                                            </iconify-icon>
                                                        </div>
                                                        <div class="single_order_column forth_column">
                                                            <input type="" name="" onfocus="select();" placeholder="Amt or %"
                                                                class="discount_cart_input" value="0" disabled>
                                                        </div>
                                                        <div class="single_order_column fifth_column text-right">
                                                            <span
                                                                id="combo_item_total_price_table_<?php echo $combo->combo_item_id ?>"><?php echo $combo->combo_item_qty * $combo->combo_item_price ?></span>
                                                            <iconify-icon icon="solar:trash-bin-minimalistic-broken"
                                                                data-id="<?php echo $combo->combo_item_id ?>"
                                                                class="combo-item-remove removeCartItemCombo"></iconify-icon>
                                                        </div>
                                                    </div>
                                                <?php }
                                            }
                        ...
                        <input type="hidden" id="edit_sale_customer"
                            value="<?php echo isset($sale_item) && $sale_item->customer_id ? $sale_item->customer_id : '' ?>">
                        <input type="hidden" id="edit_sale_customer_name"
                            value="<?php echo isset($sale_item) && $sale_item->customer_id ? getCustomerName($sale_item->customer_id) : '' ?>">
                    ...
                    <div class="bottom__info">
                        <div class="footer__content">
                            <div class="item d-flex">
                                <span class="mr-10">
                                    <iconify-icon data-tippy-content="Note" id="open_note_modal"
                                        icon="solar:notebook-linear" class="op_cursor_pointer bottom-iconify-color"
                                        width="22"></iconify-icon>
                                </span>
                                <span class="mr-10">
                                    <iconify-icon data-get-date="" data-tippy-content="Invoice Date"
                                        id="open_date_picker" icon="solar:calendar-broken"
                            ...
                            <div class="item">
                                ...
                                <span id="discounted_sub_total_amount"
                                    class="op_display_none"><?php echo getAmtPre(0) ?></span>
                            </div>
                            <!-- End Sub Total -->
                            <div class="item">
                                <div>
                            ...
                            <div class="item">
                                ...
                                <iconify-icon icon="solar:chat-round-money-broken" class="px-3 bottom-iconify-color"
                                    width="22" id="open_charge_modal"></iconify-icon>
                                <span
                                    id="show_charge_amount"><?php echo getAmtPre(isset($sale_item) && $sale_item->delivery_charge ? $sale_item->delivery_charge : 0) ?></span>
                            </div>
                            ...
                            <?php if (!moduleIsHideCheck('Delivery Partner-YES')) { ?>
                                <div class="item">
                                    ...
                                    <span id="delivery_partner_info"
                                        data-partner-id="<?php echo (isset($sale_item) && $sale_item->delivery_partner_id ? $sale_item->delivery_partner_id : 0) ?>"><?php echo getPartnerName(isset($sale_item) && $sale_item->delivery_partner_id ? $sale_item->delivery_partner_id : '') ?></span>
                                </div>
                            <?php } ?>
                            <div class="item">
                                <span class="cart-footer-title"><?php echo lang('rounding'); ?>: </span>
                                <span id="rounding"
                                    class="p-l-3"><?php echo getAmtPCustom(isset($sale_item) && $sale_item->rounding ? $sale_item->rounding : '') ?></span>
                            </div>
                            <!-- End Total Item -->
                        </div>
                        <div class="payable">
                            <h1><?php echo lang('total_payable'); ?>: <span
                                    id="total_payable"><?php echo getAmtPre(0) ?></span></h1>
                        </div>
                        <div class="main_bottom p-0">
                            <div class="button_group">
                                ...
                                <div class="cart_bottom_buttons">
                                    <button id="hold_sale"
                                        class="bg_hold off-btn d-flex align-items-center justify-content-center">
            ...
            <!-- End Left Area -->
            <div
                class="main_right <?php echo ($grocery_experience == 'Medicine' || $grocery_experience == 'Grocery') ? 'main_right_m' : '' ?>">
                <div class="right_side_search_add_item">
                    <div class="filter-form">
                        <div>
                            <i class="fas fa-search"></i>
                            <input class="op_dim_placeholder" type="text" autocomplete="off" name="search" id="search"
                                autofocus placeholder="<?php echo lang('Name_or_Code_or_Category'); ?>"
                                onfocus="this.select();">
                        </div>
                            ...
                            <div class="generic_serch_option_area">
                                <div data-tippy-content="Keep Selected to Search By Genericname">
                                    <label class="container op_color_dim_grey">
                                        <input class="generic_serch_option_checkbox" type="checkbox"
                                            name="generic_serch_option_checkbox" <?php echo $generic_name_search_option == 'Yes' ? 'checked' : '' ?>>
                        ...
                        <div>
                            ...
                            <input type="text" autocomplete="off" name="search" class="search_barcode_p"
                                id="search_barcode" placeholder="<?php echo lang('barcode'); ?>"
                                onfocus="this.select();">
                    ...
                    <?php if ($grocery_experience == 'Regular') { ?>
                        <div class="slimScrollDivCategory">
                            <button
                                ...
                                data-id=""><?php echo lang('All'); ?></button>
                            <?php
                            $i = 1;
                                ...
                                if ($single_category->name != "N/A"):
                                    if ($i = 1):
                                        ...
                                        <button
                                            ...
                                            data-id="<?= $single_category->id ?>"><?= $single_category->name ?></button>
                                        <?php
                                    else:
                                        ?>
                                        <button
            ...
            <?php if ($grocery_experience == 'Medicine') { ?>
                <div id="main_left">
                    ...
                    <div id="alternative_item_render">
                        <h6><?php echo lang('Alternative_Medicine_will_shown_here'); ?> <iconify-icon
                                icon="solar:smile-circle-broken"></iconify-icon>
                        </h6>
                    </div>
                </div>
            <?php } ?>
    ...
    <div id="video_tutorial_modal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <iframe width="100%" height="500px" src="https://youtu.be/LtmKicqTp7M?si=K3nPbWdfmYARpgqp"
    ...
    <div id="barcode_open_modal" class="modal">
        <div class="modal-content">
            ...
            <div class="btn__box">
                <button type="button"
                    class="cancel_open_camera cancel px-20 bg__red"><?php echo lang('cancel'); ?></button>
            </div>
        </div>
    </div>
    <!-- End Add Item Modal -->
    ...
    <div id="item_modal" class="modal">
        <div class="modal-content" id="add_to_cart_item_modal_content">
            ...
            <div class="item-modal-body">
                ...
                <div class="sec1_inside" id="sec1_2"><span id="item_quantity_modal" class="op_display_none">1</span>
                </div>
                <div class="sec1_inside op_display_none" id="sec1_3"> <span id="modal_item_price_variable"
                        class="op_display_none">0</span><span
                        id="modal_item_price_variable_without_discount">0</span><span id="modal_discount_amount"
                        class="op_display_none">0</span>
                </div>
                <input type="hidden" id="sale_usal_qty_modal" name="sale_usal_qty_modal" value="">
                <input type="hidden" id="allow_less_sale" name="allow_less_sale"
                    value="<?php echo escape_output($this->session->userdata('allow_less_sale')); ?>">
                    ...
                    <ul class="combo_modal_header">
                        ...
                        <li class="text-center d-flex align-items-center justify-content-center"
                            data-tippy-content="Click on checkbox to show this item in invoice.">INV <iconify-icon
                                icon="solar:info-circle-bold"></iconify-icon>
                        </li>
                        <li class="text-center d-flex align-items-center justify-content-center"
                            data-tippy-content="Click on checkbox to sale this items."><?php echo lang('cart'); ?>
                ...
                <div class="op_display_none" id="modal_discount_section">
                    <p class="op_modal_discount"><?php echo lang('Discount'); ?></p>
                </div>
                ...
                <ul class="model_price_list">
                    <li>
                        ...
                        <label tabindex="-1" for="radio_btn_3"
                            class="sale_price_active radio_btn_label model_price_three"
                            data-tippy-content="<?php echo lang('Sale_Price'); ?>: ">
                    ...
                    <li class="service_disabled">
                        <?php if ($this->session->userdata('role') == '1' || checkAccess(4, 'change_price')) { ?>
                            <input tabindex="-1" id="radio_btn_2" type="radio" class="whole_price_class" name="model_price"
                                value="modal_whole_sale_price"><?php } ?>
                        <label tabindex="-1" for="radio_btn_2"
                            data-tippy-content="<?php echo lang('whole_sale_price'); ?>: "
                            class="model_price_three whole_price_active radio_btn_label <?= isset($whole_price_show_hide) && $whole_price_show_hide == "Yes" ? '' : 'op_display_none' ?>"
                            <?php if ($this->session->userdata('role') == '1' || checkAccess(4, 'change_price')) { ?> <?php } ?>>
                    ...
                    <li class="service_disabled">
                        <?php if ($this->session->userdata('role') == '1' || checkAccess(4, 'change_price')) { ?>
                            <input tabindex="-1" disabled id="radio_btn_1" type="radio" name="model_price"
                                value="modal_purchase_price"><?php } ?>
                        <label tabindex="-1"
                            data-tippy-content="<?php echo lang('last_purchase_price'); ?>/ <?php echo lang('purchase_price'); ?>: "
                            for="radio_btn_1"
                            class="model_price_three radio_btn_label <?= isset($purchase_price_show_hide) && $purchase_price_show_hide == "Yes" ? '' : 'op_display_none' ?>"
                            <?php if ($this->session->userdata('role') == '1' || checkAccess(4, 'change_price')) { ?> <?php } ?>>
                ...
                <ul class="price_input_field op_margin_bottom_10">
                    ...
                    <li>
                        ...
                        <input tabindex="0" type="text" autocomplete="off" id="modal_item_price_input_field"
                            onfocus="select();" class="op_width_100_p op_center" value="" <?php echo $sale_price_modify == 'No' ? 'readonly' : '' ?>>
                    </li>
                    <li class="modal_qty_area">
                        ...
                        <div class="input-group">
                            ...
                            <input tabindex="0" type="text" autocomplete="off" id="item_quantity_modal_input"
                                onfocus="select();" class="op_width_100_p op_center integerchk item_enable_disable"
                                value="1">
                            <button tabindex="-1" type="button"
                    ...
                    <li>
                        ...
                        <input tabindex="0" type="text" class="op_width_100_p op_center" autocomplete="off"
                            onfocus="select();" id="modal_discount"
                            placeholder="<?php echo lang('discount_10_p_or_10'); ?>">
                    </li>
                </ul>

                <div class="margin-top-10 text-right"><b><?php echo lang('Total'); ?></b>&nbsp;&nbsp;&nbsp; <span
                        id="modal_total_price">0</span></div>
                <div>
                    <div class="op_margin_bottom_10"><b><?php echo lang('Note'); ?></b></div>
                    <textarea tabindex="0" name="item_note" id="modal_item_note"
                        placeholder="<?php echo lang('note'); ?>" maxlength="500" class="w-100"></textarea>
                    <input type="hidden" name="modal_item_g_w" id="modal_item_g_w">
                </div>
                <div id="variation_items">
                </div>
                <div class="modal-footer mt-10">
                    <button tabindex="0" class="cardBtn off_pos_btn bg__base"
                        id="add_to_cart"><?php echo lang('add_to_cart'); ?></button>
                    <button tabindex="0" class="close_item_modal off_pos_btn bg__red"
                        id="item_modal_close"><?php echo lang('cancel'); ?></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="fileUploadForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer mt-10">
                        <button type="submit" tabindex="0"
                            class="off_pos_btn bg__base"><?php echo lang('submit'); ?></button>
                        <a tabindex="0" class="off_pos_btn bg__base"
                            href="<?php echo base_url() ?>Authentication/downloadPDF/Bulk_Import_For_Sale.xlsx">
                            <?php echo lang('download_sample'); ?>
                        </a>
                        <button tabindex="0"
                            class="bg__red bulk_import_for_sale_cancel"><?php echo lang('cancel'); ?></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form class="customer_add_modal_info_holder">
                    ...
                    <div class="customer_balance_type">
                        <div>
                            ...
                            <input type="text" autocomplete="off" class="add_customer_modal_input integerchk"
                                id="customer_previous_due_modal" placeholder="<?php echo lang('opening_balance'); ?>">
                        </div>
                        <div class="mr_15">
                            ...
                            <select class="form-control select2" name="opening_balance_type" id="opening_balance_type">
                                <option value="Debit" <?php echo set_select('opening_balance_type', "Debit"); ?>>
                                    <?php echo lang('Debit'); ?>
                                </option>
                                <option value="Credit" <?php echo set_select('opening_balance_type', "Credit"); ?>>
                ...
                <div class="customer_section">
                    ...
                    <input type="text" autocomplete="off" class="add_customer_modal_input integerchk"
                        id="customer_credit_limit_modal" placeholder="<?php echo lang('credit_limit'); ?>">
                </div>
                <div class="customer_section">
                    ...
                    <input type="text" autocomplete="off" class="add_customer_modal_input integerchkPercent"
                        id="customer_discount_modal" placeholder="<?php echo lang('discount_type'); ?>">
                ...
                <div class="customer_section">
                    ...
                    <select class="form-control  select2 op_width_100_p" id="customer_price_type"
                ...
                <div class="customer_section">
                    ...
                    <select class="form-control  select2 op_width_100_p" id="customer_group_id_modal"
                        ...
                        foreach ($groups as $splrs) {
                            ?>
                            <option value="<?php echo escape_output($splrs->id) ?>" <?php echo set_select('group_id', $splrs->id); ?>>
                                <?php echo escape_output($splrs->group_name) ?>
                            </option>
                        <?php } ?>
                    </select>
                </div>
                <div class="customer_section">
                    ...
                    <input type="text" class="add_customer_modal_input" id="customer_delivery_address_modal"
                        placeholder="<?php echo lang('delivery_address'); ?>">
                </div>
                ...
                <?php if (collectGST() == "Yes") { ?>
                    <div class="customer_section">
                        ...
                        <input type="text" autocomplete="off" class="add_customer_modal_input"
                            id="customer_gst_number_modal" placeholder="<?php echo lang('gst_number'); ?>">
                ...
                <div class="customer_section">
                    ...
                    <input autocomplete="off" placeholder="<?php echo lang('date_of_birth'); ?>" type="text" readonly
                ...
                <div class="customer_section">
                    ...
                    <input placeholder="<?php echo lang('date_of_anniversary'); ?>" autocomplete="off" type="text"
                        readonly class="add_customer_modal_input " id="customer_doa_modal" data-datable="yyyymmdd"
                        data-datable-divider=" - ">
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="customedr_add_modal_info_holder">
                ...
                <label class="op_cursor_pointer op_padding_left_17">
                    <input <?= isset($qty_setting_check) && $qty_setting_check == "Yes" ? 'checked' : '' ?> type="checkbox"
                        name="qty_setting_check" value="Yes" id="qty_setting_check">
                    <?php echo lang('Check stock when selling'); ?>
                </label>
            </div>
            <div class="section7 fix">
                <div class="sec7_inside op_float_left op_display_inline" id="sec7_1"><button
                        class="op_padding_left_28 op_padding_right_28"
                        id="cancel_set_qty_alert_sms_setting"><?php echo lang('cancel'); ?></button></div>
                <div class="sec7_inside op_float_right op_display_inline" id="sec7_2"><button
                        class="op_padding_left_28 op_padding_right_28"
                        id="add_post_setting"><?php echo lang('Submit'); ?></button></div>
            </div>
        </div>
    </div>
    ...
    <div id="show_sale_hold_modal" class="modal">
        <div class="modal-content">
            <h1 class="main_header"><?php echo lang('after_sale'); ?> <a href="javascript:void(0)"
                        ...
                        <div class="hold_list_holder fix">
                            ...
                            <div class="delete_all_hold_sales_container fix">
                                <button class="bg__red"
                                    id="delete_all_hold_sales_button"><?php echo lang('delete_all_after_sales'); ?></button>
                            </div>
                        </div>
                    </div>
                    <div class="hold_sale_right fix">
                            ...
                            <div class="top_middle">
                                ...
                                <div class="waiter_customer_table">
                                    <div class="customer fix"><span
                                            class="op_font_weight_b"><?php echo lang('customer'); ?>: </span><span
                                            class="op_display_none" id="hold_customer_id"></span><span
                                ...
                                <div class="item_modifier_details item_modifier_body">
                                    <div class="modifier_item_header">
                                        ...
                                        <div class="second_column_header column_hold text-center">
                                            <?php echo lang('price'); ?>
                                        </div>
                                        <div class="third_column_header column_hold text-center">
                                            <?php echo lang('qty'); ?>
                                        </div>
                                        <div class="forth_column_header column_hold text-center">
                                            <?php echo lang('discount'); ?>
                                        </div>
                                        <div class="fifth_column_header column_hold text-right">
                                            <?php echo lang('total'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bottom_total_calculation_hold footer-content-hold">
                                        ...
                                        <div class="item">
                                            ...
                                            <span id="sub_total_hold"
                                                class="ir_display_none"><?php echo getAmtPre(0) ?></span>
                                        ...
                                        <div class="item">
                                            ...
                                            <span>
                                                <span id="sub_total_discount_hold"><?php echo getAmtPre(0) ?? 0 ?></span>
                                                (<span id="all_items_discount_hold"><?php echo getAmtPre(0) ?></span>)
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="button_holder hold_sale_right_buttom">
                            <button class="bg__green"
                                id="hold_edit_in_cart_button"><?php echo lang('edit_in_cart'); ?></button>
    ...
    <div id="show_keyboard_short_cut" class="modal">
        <div class="modal-content">
            <h1 class="main_header"><?php echo lang('keyboard_short_cut'); ?> <a href="javascript:void(0)"
                    class="alertCloseIcon">
                    <i data-feather="x"></i>
                </a>
            </h1>
    ...
    <div id="show_last_ten_sales_modal" class="modal op_max_width_1050">
        <div class="modal-content modal-xl" id="modal_content_last_ten_sales">
            <h1 class="main_header"><?php echo lang('last_ten_sales'); ?> <a href="javascript:void(0)"
                    class="alertCloseIcon">
                    <i data-feather="x"></i>
                </a>
            </h1>
                    ...
                    <select class="select2 op_width_100_p" name="customer_c" id="customer_c">
                        ...
                        <?php foreach ($customers as $customer) { ?>
                            <option value="<?php echo escape_output($customer->id); ?>">
                                ...
                                <?php echo escape_output($customer->phone != '' ? '(' . $customer->phone . ')' : ''); ?>
                            </option>
                        <?php } ?>
                    </select>
                ...
                <div class="last_ten_sales_holder fix">
                    ...
                    <div class="hold_sale_right fix hold_sale_right_height">
                            ...
                            <div class="top_middle fix">
                                ...
                                <div class="waiter_customer_table fix">
                                    <div class="customer fix"><span
                                            ...
                                            id="last_10_customer_name"></span> <span
                                            id="last_ten_customer_mobile"></span></div>
                                </div>
                                <div class="item_modifier_details item_modifier_details_body fix">
                                    <div class="modifier_item_header">
                                        ...
                                        <div class="forth_column_header column_hold"><?php echo lang('discount'); ?>
                                        </div>
                                ...
                                <div class="item_modifier_details fix">
                                    <div class="bottom_total_calculation_hold footer-content op_padding_10_important">
                                        <div class="single_row">
                                            ...
                                            <div class="third_column"> <span
                                                    id="sub_total_show_last_10"><?php echo getAmtPre(0) ?></span>
                                        ...
                                        <div class="single_row">
                                            <div class="label"><?php echo lang('total_item'); ?>: <span
                                                    id="total_items_in_cart_last_10"><?php echo getAmtPre(0) ?></span>
                                                (<span
                                                    id="total_items_qty_in_cart_last_10"><?php echo getAmtPre(0) ?></span>)
                                            </div>
                                        </div>
                                        ...
                                        <div class="single_row">
                                            ...
                                            <span id="all_items_vat_last_10"
                                                class="op_overflow_auto op_display_block op_height_20"><?php echo getAmtPre(0) ?></span>
                                        </div>
                                        <div class="single_row">
                                    ...
                                    <div class="total_payable">
                                        ...
                                        <span class="second_column"><span
                                                id="total_payable_last_10"><?php echo getAmtPre(0) ?></span></span>
                                    </div>
                                    <div class="footer-content bottom_total_calculation_hold">
                                        <div class="single_row">
                                            <div class="label"><?php echo lang('paid_amount'); ?>:</div>
                                            <div class="second_column"> <span
                                                    id="paid_amount_last_10"><?php echo getAmtPre(0) ?></span></div>
                                        </div>
                                        <div class="single_row">
                                            <div class="label"><?php echo lang('due_amount'); ?>:</div>
                                            <div class="third_column"> <span
                                                    id="due_amount_last_10"><?php echo getAmtPre(0) ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="button_holder hold_sale_right_bottom">
                            <button id="last_ten_print_invoice_button"
                                class="bg__grey"><?php echo lang('print_invoice'); ?></button>
                            <button id="last_ten_print_challan_button"
                                class="bg__grey"><?php echo lang('print_challan'); ?></button>
                            <button id="last_ten_sales_edit_buttons"
                                class="bg_hold"><?php echo lang('edit'); ?></button>
    ...
    <div id="show_keyboard_shortcut_modal" class="modal">
        <div class="modal-content" id="modal_content_keyboard_shortcut">
            <h1 class="main_header"><?php echo lang('keyboard_shortcuts'); ?> <a href="javascript:void(0)"
                    class="alertCloseIcon">
                    <i data-feather="x"></i>
                </a>
            </h1>
    ...
    <div id="generate_sale_hold_modal" class="modal">
        <div class="modal-content" id="modal_content_generate_hold_sales">
            ...
            <div class="generate_hold_sale_modal_info_holder fix">
                ...
                <input type="text" autocomplete="off" id="hold_generate_input"
                    placeholder="<?php echo lang('hold_number'); ?>">
                ...
                <div class="payment-list order-payment-list">
                    <div class="finalize-button-wrap">
                        <div class="payment_btn_toggler">
                            <button type="button" class="btn payment_ctrl payment_mthod_ctrl active">Payment
                                Method</button>
                        ...
                        <?php foreach ($payment_methods as $value):
                            ...
                            if ($is_loyalty_enable != 'enable'):
                                if ($value->name != 'Loyalty Point'):
                                    ?>
                                    <li class="f-item">
                                        <a data-type_value="<?php echo escape_output($value->account_type); ?>"
                                            class="<?php echo escape_output($is_cash) ?> <?php echo escape_output($selected) ?> set_payment account_type"
                                            data-id="<?php echo escape_output($value->id) ?>"
                                            href="javascript:void(0)"><?php echo escape_output($value->name) ?></a>
                                    </li>
                                    <?php
                                endif;
                            else: ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; ?>
                        <li class=""> <a id="change_currency_btn" class="change_currency_btn"
                                href="javascript:void(0)"><?php echo lang('change_currency'); ?></a> </li>
                    </ul>
                    <!-- <ul id="list">
                ...
                <div class="payment_content_wrap finalize-p-inactive">
                    <div class="customer_previous_due_mobile op_mb_7">
                        <div class="finalize-mobile-view">
                            ...
                            <div class="text-rigth">
                                <p class="text-red"><b><?php echo lang('opening_balance'); ?>:</b> <span
                                        class="finalize_mobile_op_balance"></span></p>
                                <p class="d-flex justify-content-end text-red"><span
                                        class="d-none"><b><?php echo lang('change_amount'); ?>:</b></span> <span
                                        class="finalize-changes-amt-mobile"></span></p>
                            </div>
                        </div>
                    </div>
                    <div class="payment_content_left_side">
                        <div class="payment_top">
                            <div class="c_d_flex justify-content-between">
                                <h4 class="name-of-payment set_no_access my-0" id="payment_preview">
                                    <?php echo lang('Cash_Payment'); ?>
                                </h4>
                                <div class="customer_and_previous_due_info">
                                    <div class="previous_due_div">
                                        <div class="d-flex" id="previous_due_wrap">
                                            ...
                                            <span
                                                class="change_amount_color mr-10"><?php echo lang('opening_balance'); ?>:
                                            </span>&nbsp;
                                            <span class="change_amount_color" id="previous_due_show"></span>
                                            <img id="cash_img" alt="cash image"
                                                src="<?php echo base_url() ?>assets/media/dollar_sign.png">
                                        </div>
                                    </div>
                                    <div class="loyalty_point_div">
                                        <div class="d-flex">
                                            <span
                                                class="change_amount_color mr-10"><?php echo lang('available_loyalty_point'); ?>:
                                            </span>&nbsp;
                                    ...
                                    <div class="previous_due_div">
                                        <div class="change_amount_color text-center">
                                            <b><span
                                                    class="change_amount_div display_none change_amount_p ml-10"><?php echo lang('change_amount'); ?></span></b><br>
                                            <span
                                                class="change_amount_font change_amount_div display_none change_amount_p"
                            ...
                            <div class="payment_field_wrap">
                                <div class="input-field cash_div f_focus easy-get">
                                    ...
                                    <input type="text" placeholder="<?php echo lang('given_amount'); ?>"
                                        onfocus="select();" class="add_customer_modal_input set_no_access easy-put"
                                ...
                                <div class="input-field cash_div">
                                    ...
                                    <input tabindex="-1" type="text" placeholder="<?php echo lang('change_amount'); ?>"
                                        onfocus="select();" class="add_customer_modal_input set_no_access"
                                        id="finalize_change_amount_input">
                                </div>
                                <div class="input-field easy-get">
                                    <label class="label set_no_access amount_txt"><?php echo lang('amount'); ?></label>
                                    <input tabindex="-1" type="text" placeholder="<?php echo lang('amount'); ?>"
                                        class="add_customer_modal_input set_no_access easy-put"
                                        id="finalize_amount_input">
                                </div>
                                <div class="btns">
                                    <button class="add-btn start_animation set_no_access"
                                        id="add_payment"><b><?php echo lang('add'); ?></b></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="due_date_select margin-top-10">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" id="due_date" name="due_date" readonly
                                class="form-control datepicker_custom due_date_field"
                                placeholder="<?php echo lang('Due_Date'); ?>">
                        </div>
                    </div>
                        ...
                        <ul class="finalize_modal_is_mul_currency">
                            <li class="w-48 pe-3">
                                <select class="form-control select2 multi_currency w-100" id="multi_currency">
                                    <option data-multi_currency="0" value=""><?php echo lang('change_currency') ?>
                                    </option>
                                    <?php foreach ($multipleCurrencies as $value): ?>
                                        <option data-multi_currency="<?php echo escape_output($value->conversion_rate) ?>"
                                            value="<?php echo escape_output($value->currency) ?>">
                                            <?php echo escape_output($value->currency) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </li>
                            <li class="w-2"></li>
                            <li class="w-45">
                                <input type="text" placeholder="<?php echo lang('amount') ?>" onfocus="select();"
                                    readonly id="multi_currency_amount" class="custom_field w-100">
                            </li>
                            ...
                            <div class="paid-list-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="item">
                                        ...
                                        <p><span data-original_payable=""
                                                id="finalize_total_payable"><?php echo getAmt(0) ?></span></p>
                                    </div>

                                    <div class="item">
                                        <h3 class="title"><?php echo lang('paid') ?></h3>
                                        <p><span class="spincrement"
                                                id="finalize_total_paid"><?php echo getAmt(0) ?></span></p>
                                    </div>

                                    <div class="item">
                                        <h3 class="title"><?php echo lang('due') ?></h3>
                                        <p><span class="spincrement"
                                                id="finalize_total_due"><?php echo getAmt(0) ?></span></p>
                                    </div>
                                    <button type="button" class="new-btn justify-content-center"
                                        id="open_finalize_cart_details"><?php echo lang('Cart_Details') ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="right-keys">
                            <ul class="key-list">
                                <li><a id="open_finalize_discount"
                                        href="javascript:void(0)"><?php echo lang('discount') ?></a></li>
                                <li><a data-amount="" data-is_denomination=""
                                        class="set_no_access get_quick_cash set_default_quick_cach"
                                        href="javascript:void(0)"><?php echo getAmtPCustom(0) ?></a></li>
                                <li class="third">
                                    <ul>
                                        <?php
                                        if (isset($denominations) && $denominations):
                                            foreach ($denominations as $value):
                                                ?>
                                                <li><a data-is_denomination="yes"
                                                        data-amount="<?= escape_output($value->amount) ?>"
                                                        class="set_no_access get_quick_cash"
                                                        href="javascript:void(0)"><?php echo escape_output($value->amount) ?></a>
                                                </li>
                                                <?php
                                            endforeach;
                                        endif;
                                ...
                                <li class="clear">
                                    <a href="javascript:void(0)"
                                        class="new-btn-danger justify-content-center clear-btn clear_quick_data set_no_access"><?php echo lang('Clear') ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="sms-email-mobile d-flex justify-content-end my-20">
                        ...
                        <label class="container op_margin_top_6 op_color_dim_grey mr-10 send_sms_finalize">
                            <?php echo lang('send_invoice_via_sms'); ?>
                        ...
                        <label class="container op_margin_top_6 op_color_dim_grey  mr-10 send_email_finalize">
                            <?php echo lang('send_invoice_via_email'); ?>
                        ...
                        <?php if ($getCompanyInfo->whatsapp_invoice_enable_status == 'Enable') { ?>
                            <label class="container op_margin_top_6 op_color_dim_grey send_wm_finalize">
                                <?php echo lang('send_invoice_via_whatsapp'); ?>
            ...
            <div class="main-content-wrapper">
                <div class="discunt_check_modal">
                    ...
                    <input type="text" onfocus="select()" class="form-control discount_permission_code" value=""
                        placeholder="<?php echo lang('discount_permission_code'); ?>">
                    <div class="alert pos_error_counter alert-error error-msg">
                ...
                <div class="easy-get discount_field">
                    ...
                    <input type="text" onfocus="select()" class="form-control total_disc easy-put"
                        placeholder="<?php echo lang('10_p_or_10'); ?>" id="sub_total_discount">
                    <span class="ir_display_none" id="sub_total_discount_amount"></span>
                </div>
            </div>
            <div class="btn__box">
                <button type="button" id="submit_discount_custom"
                    class="bg__blue px-20 bg__blue"><?php echo lang('submit'); ?></button>
                <button type="button" id="cancel_discount_modal"
                    class="cancel px-20 bg__red"><?php echo lang('cancel'); ?></button>
            </div>
        </div>
    </div>
    <!-- Discount Modal End -->
    ...
    <div id="finalize_discount_modal" class="modal">
        <div class="modal-content">
            ...
            <div class="btn__box">
                ...
                <button type="button"
                    class="cancel_modal bg__red remove_discount"><?php echo lang('cancel'); ?></button>
            </div>
        </div>
    </div>
            ...
            <div class="main-content-wrapper">
                <div class="form-group mt-3">
                    ...
                    <select id="charge_type" class="select2">
                        <option <?php echo isset($sale_item) && $sale_item->charge_type == "delivery" ? 'selected' : '' ?>
                            value="delivery"><?php echo lang('delivery'); ?></option>
                        <option <?php echo isset($sale_item) && $sale_item->charge_type == "service" ? 'selected' : '' ?>
                ...
                <div class="form-group margin-top-15 easy-get">
                    ...
                    <input type="text" autocomplete="off" class="form-control easy-put integerchk"
                        ...
                        value="<?php echo getAmtPre(isset($sale_item) && $sale_item->delivery_charge ? $sale_item->delivery_charge : 0) ?>"
                        id="delivery_charge">
                </div>
            </div>
            <div class="btn__box">
                <button type="button"
                    class="submit bg__blue px-20 delivery_charge_submit"><?php echo lang('submit'); ?></button>
    ...
    <div id="delivery_partner" class="modal">
        <div class="modal-content">
                    ...
                    <select id="delivery_partner_list" class="select2 form-control">
                        ...
                        <?php if (isset($delivery_partners) && $delivery_partners) {
                            foreach ($delivery_partners as $key => $partner) {
                                ?>
                                <option <?php echo isset($sale_item) && $sale_item->charge_type == "delivery" ? 'selected' : '' ?>
                                    value="<?php echo escape_output($partner->id) ?>">
                                    <?php echo escape_output($partner->partner_name); ?>
                                </option>
                            <?php }
                        } ?>
                    </select>
            ...
            <div class="btn__box">
                <button type="button" class="submit bg__blue px-20"
                    id="delivery_partner_submit"><?php echo lang('submit'); ?></button>
                <button type="button" class="cancel bg__red px-20"><?php echo lang('cancel'); ?></button>
            </div>
        </div>
    </div>
    ...
    <div class="cus_pos_modal modal" id="register_modal">
        ...
        <div class="pos__modal__body scrollbar-macosx">
            <div class="default_inner_body" id="register_details_content_o">
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('register_details'); ?>"
        ...
        <footer class="pos__modal__footer">
            <div class="right_box">
                <button type="button" id="register_close"
                    class="btn bg__grey"><?php echo lang('close_register'); ?></button>
    ...
    <div id="show_all_promo" class="modal">
        <div class="modal-content modal_content_hold_sales">
            <h1 class="main_header"><?php echo lang('Promotion_Items'); ?> <a href="javascript:void(0)"
                    class="alertCloseIcon">
                    <i data-feather="x"></i>
                </a>
            </h1>
        ...
        <ul class="pos__menu__list">
            ...
            <?php if (isServiceAccess('', '', 'sGmsJaFJE') && (defined('FCCPATH') && FCCPATH != 'Bangladesh')) { ?>
                <li class="have_sub_menu">
                    ...
                    <ul class="sub__menu__list">
                        ...
                        <li data-access="edit-23"
                            class="menu_assign_class <?= getWhiteLabelStatus() == 1 ? 'd-block' : 'd-none' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="add-133" class="menu_assign_class " module-is-hide="Promotion-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Promotion/addEditPromotion' ?>">
                            <?php echo lang('add_promotion'); ?>
                            <iconify-icon icon="solar:crown-star-line-duotone"
                                class="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? '' : 'd-none' ?>">
                            </iconify-icon>
                        </a>
                    </li>
                    <li data-access="add-133" class="menu_assign_class " module-is-hide="Promotion-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Promotion/promotions' ?>">
                    ...
                    <li data-access="add-159" class="menu_assign_class " module-is-hide="Delivery Partner-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Delivery_partner/addEditPartner' ?>">
                    ...
                    <li data-access="add-159" class="menu_assign_class " module-is-hide="Delivery Partner-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Delivery_partner/listPartner' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="list-49" class="menu_assign_class " module-is-hide="Item-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Item/bulkItemUpdate' ?>">
                    ...
                    <li data-access="add-304" class="menu_assign_class " module-is-hide="Rack-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Rack/addEditRack' ?>">
                    ...
                    <li data-access="list-304" class="menu_assign_class " module-is-hide="Rack-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Rack/rackList' ?>">
                    ...
                    <li data-access="add-70" class="menu_assign_class " module-is-hide="Variation Attribute-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Variation/addEditVariation' ?>">
                    ...
                    <li data-access="list-70" class="menu_assign_class " module-is-hide="Variation Attribute-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Variation/variations' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-198" class="menu_assign_class" module-is-hide="Customer Receive-YES">
                        <a class="child-menu "
                            href="<?php echo base_url(); ?>Customer_due_receive/addCustomerDueReceive">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="add-223" class="menu_assign_class " module-is-hide="Diposit-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Deposit/addEditDeposit' ?>">
                    ...
                    <li data-access="list-223" class="menu_assign_class " module-is-hide="Diposit-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Deposit/deposits' ?>">
                    ...
                    <li data-access="list-228" class="menu_assign_class " module-is-hide="Balance Sheet-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Accounting/balanceStatement' ?>">
                    ...
                    <li data-access="list-230" class="menu_assign_class " module-is-hide="Trial Balance-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Accounting/trialBalance' ?>">
                    ...
                    <li data-access="list-232" class="menu_assign_class " module-is-hide="Balance Statement-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Accounting/balanceSheet' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="add-234" class="menu_assign_class " module-is-hide="Attendance-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Attendance/addEditAttendance' ?>">
                    ...
                    <li data-access="list-234" class="menu_assign_class " module-is-hide="Attendance-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Attendance/attendances' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li data-access="register_report-249" class="menu_assign_class "
                        module-is-hide="Register Report-YES">
                    ...
                    <li data-access="zReport-249" class="menu_assign_class " module-is-hide="Z Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/zReport' ?>">
                    ...
                    <li data-access="daily_summary_report-249" class="menu_assign_class "
                        module-is-hide="Daily Summary Report-YES">
                    ...
                    <li data-access="service_sale_report-249" class="menu_assign_class"
                        module-is-hide="Service Sale Report-YES">
                        <a class="child-menu " href="<?php echo base_url(); ?>Report/serviceSaleReport">
                            <?php echo lang('service_sale_report'); ?>
                        </a>
                    </li>
                    <li data-access="service_sale_report-249" class="menu_assign_class "
                        module-is-hide="Combo Service Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/comboServiceReport' ?>">
                    ...
                    <li data-access="stock_report-249" class="menu_assign_class " module-is-hide="Stock Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/expiryStock' ?>">
                    ...
                    <li data-access="employee_sale_report-249" class="menu_assign_class "
                        module-is-hide="Employee Sale Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/employeeSaleReport' ?>">
                    ...
                    <li data-access="customer_receive_report-249" class="menu_assign_class"
                        module-is-hide="Customer Receive Report-YES">
                    ...
                    <li data-access="attendance_report-249" class="menu_assign_class "
                        module-is-hide="Attandance Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/attendanceReport' ?>">
                    ...
                    <li data-access="product_profit_report-249" class="menu_assign_class "
                        module-is-hide="Product Profit Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/productProfitReport' ?>">
                    ...
                    <li data-access="supplier_ledger-249" class="menu_assign_class"
                        module-is-hide="Supplier Ledger Report-YES">
                    ...
                    <li data-access="supplier_balance_report-249" class="menu_assign_class "
                        module-is-hide="Supplier Balance Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Company_report/supplierBalanceReport' ?>">
                    ...
                    <li data-access="customer_ledger-249" class="menu_assign_class "
                        module-is-hide="Customer Ledger Report-YES">
                    ...
                    <li data-access="customer_balance_report-249" class="menu_assign_class "
                        module-is-hide="Customer Balance Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Company_report/customerBalanceReport' ?>">
                    ...
                    <?php if (!moduleIsHideCheck('Servicing-YES')) { ?>
                        <li data-access="servicing_report-249" class="menu_assign_class "
                            module-is-hide="Servicing Report-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/servicingReport' ?>">
                    ...
                    <li data-access="product_sale_report-249" class="menu_assign_class "
                        module-is-hide="Product Sale Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/productSaleReport' ?>">
                    ...
                    if ($collect_tax == "Yes") {
                        ...
                        <li data-access="tax_report-249" class="menu_assign_class " module-is-hide="Tax Report-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/taxReport' ?>">
                    ...
                    <li data-access="detailed_sale_report-249" class="menu_assign_class "
                        module-is-hide="Detailed Sale Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/detailedSaleReport' ?>">
                    ...
                    <li data-access="low_stock_report-249" class="menu_assign_class "
                        module-is-hide="Low Stock Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/getStockAlertList' ?>">
                    ...
                    <li data-access="profit_loss_report-249" class="menu_assign_class"
                        module-is-hide="Profit Loss Report-YES">
                    ...
                    <li data-access="purchase_report-249" class="menu_assign_class "
                        module-is-hide="Purchase Report-YES">
                    ...
                    <li data-access="product_purchase_report-249" class="menu_assign_class "
                        module-is-hide="Product Purchase Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/productPurchaseReport' ?>">
                    ...
                    <li data-access="income_report-249" class="menu_assign_class " module-is-hide="Income Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/incomeReport' ?>">
                    ...
                    <li data-access="salary_report-249" class="menu_assign_class " module-is-hide="Salary Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/salaryReport' ?>">
                    ...
                    <li data-access="purchase_return_report-249" class="menu_assign_class "
                        module-is-hide="Purchase Return Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/purchaseReturnReport' ?>">
                    ...
                    <li data-access="sale_return_report-249" class="menu_assign_class "
                        module-is-hide="Sale Return Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/saleReturnReport' ?>">
                    ...
                    <?php if (!moduleIsHideCheck('Damage-YES')) { ?>
                        <li data-access="damage_report-249" class="menu_assign_class " module-is-hide="Damage Report-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/damageReport' ?>">
                    ...
                    <?php if (!moduleIsHideCheck('Installment-YES')) { ?>
                        <li data-access="installment_report-249" class="menu_assign_class "
                            module-is-hide="Installment Report-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/installmentReport' ?>">
                        ...
                        <li data-access="installment_due_report-249" class="menu_assign_class "
                            module-is-hide="Installment Due Report-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/installmentDueReport' ?>">
                    ...
                    <li data-access="item_tracing_report-249" class="menu_assign_class "
                        module-is-hide="Item Tracing Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/itemMoving' ?>">
                    ...
                    <li data-access="price_history_report-249" class="menu_assign_class "
                        module-is-hide="Price History Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/priceHistory' ?>">
                    ...
                    <li data-access="cash_flow_report-249" class="menu_assign_class "
                        module-is-hide="Cash Flow Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Company_report/cashFlowReport' ?>">
                    ...
                    <li data-access="available_loyalty_point-249" class="menu_assign_class "
                        module-is-hide="Available Loyalty Point Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/availableLoyaltyPointReport' ?>">
                    ...
                    <li data-access="usage_loyalty_point-249" class="menu_assign_class "
                        module-is-hide="Usages Loyalty Point Report-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Report/usageLoyaltyPointReport' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list ">
                    <li data-access="add-182" class="menu_assign_class " module-is-hide="Income-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Income/addEditIncome' ?>">
                    ...
                    <li data-access="list-182" class="menu_assign_class " module-is-hide="Income-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Income/incomes' ?>">
                    ...
                    <li data-access="add-187" class="menu_assign_class " module-is-hide="Income Category-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'IncomeItem/addEditIncomeItem' ?>">
                    ...
                    <li data-access="list-187" class="menu_assign_class " module-is-hide="Income Category-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'IncomeItem/incomeItems' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-204" class="menu_assign_class " module-is-hide="Sale Return-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Sale_return/addEditSaleReturn' ?>">
                    ...
                    <li data-access="list-204" class="menu_assign_class " module-is-hide="Sale Return-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Sale_return/saleReturns' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="add-211" class="menu_assign_class " module-is-hide="Purchase Return-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Purchase_return/addEditPurchaseReturn' ?>">
                    ...
                    <li data-access="list-211" class="menu_assign_class " module-is-hide="Purchase Return-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Purchase_return/purchaseReturns' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="edit-1" class="menu_assign_class ">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/moduleManagement' ?>">
                    ...
                    <li data-access="whatsappSetting-327" class="menu_assign_class "
                        module-is-hide="Whatsapp Setting-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/whatsappSetting' ?>">
                    ...
                    <li data-access="edit-8" class="menu_assign_class " module-is-hide="Tax Setting-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Tax_setting/tax' ?>">
                    ...
                    <li data-access="edit-10" class="menu_assign_class " module-is-hide="Email Setting-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Email_setting/emailConfiguration' ?>">
                    ...
                    <li data-access="edit-12" class="menu_assign_class " module-is-hide="SMS Setting-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Short_message_service/smsService' ?>">
                    ...
                    <li data-access="edit-14" class="menu_assign_class " module-is-hide="Printer Setup-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Printer/printerSetup' ?>">
                    ...
                    <?php if (!isServiceAccess('', '', 'sGmsJaFJE') && (defined('FCCPATH') && FCCPATH != 'Bangladesh')) { ?>
                        <li data-access="edit-23"
                            class="menu_assign_class <?= getWhiteLabelStatus() == 1 ? 'd-block' : 'd-none' ?>"
                            module-is-hide="White Label-YES">
                            <a class="child-menu " href="<?php echo base_url(); ?>WhiteLabel/index">
                                <?php echo lang('white_label'); ?>
                            </a>
                        </li>
                    ...
                    <li data-access="edit-335" class="menu_assign_class " module-is-hide="Payment Getway-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Payment_getway/paymentGetway' ?>">
                    ...
                    <li data-access="edit-311" class="menu_assign_class " module-is-hide="Multiple Currency-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'MultipleCurrency/addEditMultipleCurrency' ?>">
                    ...
                    <li data-access="edit-311" class="menu_assign_class " module-is-hide="Multiple Currency-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'MultipleCurrency/multipleCurrencies' ?>">
                    ...
                    <li data-access="add_dummy_data-325" class="menu_assign_class "
                        module-is-hide="Import Dummy Data-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : 'add_dummy_data' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/add_dummy_data' ?>">
                    ...
                    <li data-access="deleteDummyData-329" class="menu_assign_class "
                        module-is-hide="Delete Dummy Data-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : 'delete' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/deleteDummyData' ?>">
                    ...
                    <li data-access="wipeTransactionalData-331" class="menu_assign_class "
                        module-is-hide="Wipe Transactional Data-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : 'delete' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/wipeTransactionalData' ?>">
                    ...
                    <li data-access="wipeAllData-333" class="menu_assign_class " module-is-hide="Wipe All Data-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : 'delete' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Setting/wipeAllData' ?>">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="change_profile-287" class="menu_assign_class"
                        module-is-hide="Employee Management-YES">
                ...
                <li class="have_sub_menu">
                    ...
                    <ul class="sub__menu__list">
                        ...
                        <li data-access="add-93" class="menu_assign_class " module-is-hide="Installment Customer-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/addEditCustomer' ?>">
                        ...
                        <li data-access="list-93" class="menu_assign_class " module-is-hide="Installment Customer-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/customers' ?>">
                        ...
                        <li data-access="add-100" class="menu_assign_class " module-is-hide="Installment Sale-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/addEditInstallmentSale' ?>">
                        ...
                        <li data-access="list-100" class="menu_assign_class " module-is-hide="Installment Sale-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/installmentSales' ?>">
                        ...
                        <li data-access="installment_collection-100" class="menu_assign_class "
                            module-is-hide="Installment Sale-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/installmentCollections' ?>">
                        ...
                        <li data-access="due_installment-100" class="menu_assign_class "
                            module-is-hide="Installment Sale-YES">
                            <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                                href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Installment/listDueInstallment' ?>">
                                <?php echo lang('installment_collection'); ?>
                                <iconify-icon icon="solar:crown-star-line-duotone"
                                    class="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? '' : 'd-none' ?>">
                                </iconify-icon>
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="filter-85" class="menu_assign_class " module-is-hide="Warranty-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Warranty/checkWarranty' ?>">
                    ...
                    <li data-access="add-80" class="menu_assign_class " module-is-hide="Warranty-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'WarrantyProducts/addEditWarrantyProduct' ?>">
                    ...
                    <li data-access="list-80" class="menu_assign_class " module-is-hide="Warranty-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'WarrantyProducts/listWarrantyProduct' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="list-87" class="menu_assign_class " module-is-hide="Salary-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Salary/generate' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-32" class="menu_assign_class " module-is-hide="Fixed Item-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_assets/addEditItem' ?>">
                            <?php echo lang('add_item'); ?>
                            <iconify-icon icon="solar:crown-star-line-duotone"
                                class="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? '' : 'd-none' ?>">
                            </iconify-icon>
                    ...
                    <li data-access="list-32" class="menu_assign_class " module-is-hide="Fixed Item-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_assets/listItem' ?>">
                            <?php echo lang('list_item'); ?>
                            <iconify-icon icon="solar:crown-star-line-duotone"
                                class="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? '' : 'd-none' ?>">
                            </iconify-icon>
                    ...
                    <li data-access="add-37" class="menu_assign_class " module-is-hide="Stock In-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_asset_stock/addEditStock' ?>">
                    ...
                    <li data-access="list-37" class="menu_assign_class " module-is-hide="Stock In-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_asset_stock/listStock' ?>">
                    ...
                    <li data-access="add-42" class="menu_assign_class " module-is-hide="Stock Out-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_asset_stock_out/addEditStockOut' ?>">
                    ...
                    <li data-access="list-42" class="menu_assign_class " module-is-hide="Stock Out-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_asset_stock_out/listStockOut' ?>">
                    ...
                    <li data-access="view-47" class="menu_assign_class " module-is-hide="Stock Out-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Fixed_asset_stock/stocks' ?>">
                            <?php echo lang('stock'); ?>
                            <iconify-icon icon="solar:crown-star-line-duotone"
                                class="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? '' : 'd-none' ?>">
                            </iconify-icon>
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-239" class="menu_assign_class " module-is-hide="Quatation-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Quotation/addEditQuotation' ?>">
                    ...
                    <li data-access="list-239" class="menu_assign_class " module-is-hide="Quatation-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Quotation/quotations' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-125" class="menu_assign_class " module-is-hide="Transfer-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Transfer/addEditTransfer' ?>">
                    ...
                    <li data-access="list-125" class="menu_assign_class " module-is-hide="Transfer-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Transfer/transfers' ?>">
            ...
            <li class="have_sub_menu ">
                ...
                <ul class="sub__menu__list">
                    <li data-access="add-166" class="menu_assign_class " module-is-hide="Damage-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Damage/addEditDamage' ?>">
                    ...
                    <li data-access="list-166" class="menu_assign_class " module-is-hide="Damage-YES">
                        <a class="child-menu <?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'biponi_silver' : '' ?>"
                            href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url() . 'Damage/damages' ?>">
            ...
            $company_id = $this->session->userdata('company_id');
            $user_id = $this->session->userdata('user_id');
            if ((isServiceAccess2($user_id, $company_id, 'sGmsJaFJE') == 'Not SaaS') && FCCPATH != 'Bangladesh') { ?>
                <li data-access="update-247" class=" have_sub_menu2 menu_assign_class" module-is-hide="Update Software-YES">
                ...
                <li data-access="uninstall-318" class=" have_sub_menu2 menu_assign_class"
                    module-is-hide="Uninstall Licence-YES">
    ...
    <div id="message-modal" class="message-modal">
        <div class="modal-content">
            ...
            <h2 class="d-flex align-items-center">
                <iconify-icon icon="solar:shield-warning-broken"></iconify-icon> Invoice Not Configure!
            </h2>
            <h4 class="pb-4">Your invoice is not configured, please configure the invoice, otherwise the sale number
                will insert incorrect. <a href="<?php echo base_url(); ?>Setting/invoiceSetting" target="_blank"
                    class="link-color">Configure here</a>.</h4>
        </div>
    </div>
    ...
    <script src="<?php echo base_url(); ?>assets/POS/js/virtual_keyboard/jquery.keyboard.extension-autocomplete.js">
    </script>
    ...
    <script
        src="<?php echo base_url(); ?>frequent_changing/newDesign/lib/perfect-scrollbar/dist/perfect-scrollbar.min.js">
        </script>
